...
## 🧑‍💻 About Me
- Introduce
  - 안녕하세요! 소프트웨어 개발자 박건우입니다.
  - 현업에서 로그 모니터링 시스템을 구축하고 운영한 경험이 있습니다.
  - 특정 도메인만 고집하기 보다 더 나은 시스템을 위해 만들기 위해 고민하며 공부하고 있습니다.
- Profile
  - 서경대학교 컴퓨터공학과 졸업
  - 데이터 엔지니어 재직 ( 25.02 ~ 현재 )

## 🚀 Career
>### LLOYDK - Data Engineer ( 25.02 ~ 현재 )
> - **LG U+ 로그 모니터링 프로젝트**
> 	- 데이터 파이프라인 구축 및 운영
> 		- 로그 수집 및 정제
> 		- 로그 파티셔닝 로직 개발 및 S3 적재
> 		- 로그 파싱 로직 리팩토링 및 캐싱 적용을 통한 성능 최적화
> 	- 이상 징후 모니터링
> 		- Email 연동한 Alert 로직 개발 
> 	- 대시보드 제작
> 		- 고객 요구사항에 따른 대시보드 제작
> 		
> - **내부 검색 솔루션 시연 웹 제작 프로젝트**
> 	- 백엔드 및 프론트엔드 개발
> 		- 검색 RestAPI 및 화면 개발
>		- 임베딩 로직 개발
> 	- 데이터 전처리 및 샘플데이터 적재
> 	
> - **기술 스택**
> 	- Elastic Stack(ELK), SpringBoot, FastAPI, React.js
